...
const Sales = () => {
  const columns = ['#', 'Customer', 'Product', 'Qty', 'Payment Type', 'Add Date'];
  const actions = [
  ...
  return (
    <div className="p-6 mt-14 sm:ml-64">
      <div className="pb-2 border-b border-gray-200 flex justify-between items-center">
        <span className="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap">Sales</span>
      ...
      <Table data={salesData} columns={columns} actions={actions} />
